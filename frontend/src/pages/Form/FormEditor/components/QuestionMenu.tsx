  ...
  return (
    <div className="absolute -right-52 top-0 flex flex-col w-48 bg-white shadow-lg border border-gray-100 rounded-xl p-2 space-y-1 z-10 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-200">
      ...
      <button 
        ...
        className="flex items-center p-2 hover:bg-violet-50 rounded-md text-gray-600 transition-colors group"
      >
        <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-violet-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* 2. 画像を挿入 */}
      <button className="flex items-center p-2 hover:bg-violet-50 rounded-md text-gray-600 transition-colors group">
        <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-violet-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
